                ...
                List {
                    ...
                    Section {
                        ...
                        VStack(alignment: .leading) {
                            ...
                            Picker("Show Rides", selection: $viewModel.rideStatusFilter) {
                                Text("All").tag(RideStatusFilter.all)
                                Text("Open").tag(RideStatusFilter.open)
                                Text("Closed").tag(RideStatusFilter.nonOpen)
                            }
